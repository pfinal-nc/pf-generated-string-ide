...
public class GenerateUserInfoAction extends AnAction {
    ...
    public static String generateString(String name, String phone, String email) {
    ...
    public static @NotNull String getEmail(int lMin, int lMax) {
    ...
    public static @NotNull String getTelephone() {
    ...
    public static @NotNull String getLandline() {
        int index = getNum(0, telFirst.length - 1);
        String first = telFirst[index];
        String second = String.valueOf(getNum(1, 888) + 10000).substring(1);
        String thrid = String.valueOf(getNum(1, 9100) + 10000).substring(1);
    ...
    public static @NotNull String getChineseName() {
